...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2s_transceiver is
  ...
  signal data_outl : STD_LOGIC_VECTOR ( 23 downto 8 );
  ...
  signal \data_outl2_carry__2_i_5_n_0\ : STD_LOGIC;
  signal \data_outl2_carry__2_i_6_n_0\ : STD_LOGIC;
  signal \data_outl2_carry__2_i_6_n_1\ : STD_LOGIC;
  signal \data_outl2_carry__2_i_6_n_2\ : STD_LOGIC;
  signal \data_outl2_carry__2_i_6_n_3\ : STD_LOGIC;
  signal \data_outl2_carry__2_n_1\ : STD_LOGIC;
  ...
  signal \data_outl[23]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \dina[31]_i_3_n_0\ : STD_LOGIC;
  signal \dina[31]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \dina[31]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \data_outl2_carry__2_i_6\ : label is 35;
  ...
  attribute SOFT_HLUTNM of sd_tx_i_5 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of ws_int_i_2 : label is "soft_lutpair0";
begin
  control <= \^control\;
  enb <= \^enb\;
  sclk <= \^sclk\;
...
data_outl2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => data_outl2_carry_i_1_n_0,
      DI(1) => '0',
      DI(0) => data_outl2_carry_i_2_n_0,
...
\data_outl2_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \data_outl2_carry__2_i_2_n_0\,
      S(2) => \data_outl2_carry__2_i_3_n_0\,
      S(1) => \data_outl2_carry__2_i_4_n_0\,
      S(0) => \data_outl2_carry__2_i_5_n_0\
    );
...
\data_outl2_carry__2_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\data_outl2_carry__2_i_6\: unisim.vcomponents.CARRY4
     port map (
      CI => \data_outl2_carry__1_i_5_n_0\,
      CO(3) => \data_outl2_carry__2_i_6_n_0\,
      CO(2) => \data_outl2_carry__2_i_6_n_1\,
      CO(1) => \data_outl2_carry__2_i_6_n_2\,
      CO(0) => \data_outl2_carry__2_i_6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\data_outl[23]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\dina[31]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\dina[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\dina[31]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\dina[31]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\dina[31]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\dina[31]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\dina[31]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
sd_tx_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
ws_int_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DFFF2000"
    )
        port map (
...
ws_int_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
