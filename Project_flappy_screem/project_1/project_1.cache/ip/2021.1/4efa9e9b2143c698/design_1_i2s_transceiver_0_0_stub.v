...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(reset_n, mclk, sclk, ws, sd_tx, sd_rx, addra, dina, ena, 
  rsta, wea, douta, addrb, dinb, enb, rstb, web, doutb, control)
/* synthesis syn_black_box black_box_pad_pin="reset_n,mclk,sclk,ws,sd_tx,sd_rx,addra[31:0],dina[31:0],ena,rsta,wea[3:0],douta[31:0],addrb[31:0],dinb[31:0],enb,rstb,web[3:0],doutb[31:0],control" */;
  input reset_n;
  input mclk;
  output sclk;
  output ws;
