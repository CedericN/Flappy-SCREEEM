...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(reset_n, mclk, sclk, ws, sd_tx, sd_rx, l_data_tx, 
  r_data_tx, l_data_rx, r_data_rx)
/* synthesis syn_black_box black_box_pad_pin="reset_n,mclk,sclk,ws,sd_tx,sd_rx,l_data_tx[23:0],r_data_tx[23:0],l_data_rx[23:0],r_data_rx[23:0]" */;
  input reset_n;
  input mclk;
  output sclk;
  output ws;
