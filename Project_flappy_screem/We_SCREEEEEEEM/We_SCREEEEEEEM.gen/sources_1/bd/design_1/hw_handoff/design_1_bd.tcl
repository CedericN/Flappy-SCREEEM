...
proc create_root_design { parentCell } {
  ...
  set mclk_1 [ create_bd_port -dir O mclk_1 ]
  ...
  set ws_0 [ create_bd_port -dir O ws_0 ]
  set ws_1 [ create_bd_port -dir O ws_1 ]
...
1#UART 1#Unbonded#Unbonded#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins NeopixelDriver_0/S00_AXI] [get_bd_intf_pins axi_smc/M03_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins Pmod_I2S2_0/S00_AXI] [get_bd_intf_pins axi_smc/M04_AXI]
  ...
  connect_bd_net -net NeopixelDriver_0_D_out [get_bd_ports D_out_0] [get_bd_ports Green] [get_bd_pins NeopixelDriver_0/D_out]
  ...
  connect_bd_net -net Pmod_I2S2_0_addra [get_bd_pins Pmod_I2S2_0/addra] [get_bd_pins axi_bram_ctrl_1_bram/addrb]
  connect_bd_net -net Pmod_I2S2_0_addrb [get_bd_pins Pmod_I2S2_0/addrb] [get_bd_pins axi_bram_ctrl_2_bram/addrb]
  connect_bd_net -net Pmod_I2S2_0_dina [get_bd_pins Pmod_I2S2_0/dina] [get_bd_pins axi_bram_ctrl_1_bram/dinb]
  connect_bd_net -net Pmod_I2S2_0_dinb [get_bd_pins Pmod_I2S2_0/dinb] [get_bd_pins axi_bram_ctrl_2_bram/dinb]
  connect_bd_net -net Pmod_I2S2_0_ena [get_bd_pins Pmod_I2S2_0/ena] [get_bd_pins axi_bram_ctrl_1_bram/enb]
  connect_bd_net -net Pmod_I2S2_0_enb [get_bd_pins Pmod_I2S2_0/enb] [get_bd_pins axi_bram_ctrl_2_bram/enb]
  connect_bd_net -net Pmod_I2S2_0_rsta [get_bd_pins Pmod_I2S2_0/rsta] [get_bd_pins axi_bram_ctrl_1_bram/rstb]
  connect_bd_net -net Pmod_I2S2_0_rstb [get_bd_pins Pmod_I2S2_0/rstb] [get_bd_pins axi_bram_ctrl_2_bram/rstb]
  connect_bd_net -net Pmod_I2S2_0_sclk [get_bd_ports sclk_0] [get_bd_ports sclk_1] [get_bd_pins Pmod_I2S2_0/sclk]
  connect_bd_net -net Pmod_I2S2_0_sd_tx [get_bd_ports Red] [get_bd_ports sd_tx_0] [get_bd_pins Pmod_I2S2_0/sd_tx]
  connect_bd_net -net Pmod_I2S2_0_wea [get_bd_pins Pmod_I2S2_0/wea] [get_bd_pins axi_bram_ctrl_1_bram/web]
  connect_bd_net -net Pmod_I2S2_0_web [get_bd_pins Pmod_I2S2_0/web] [get_bd_pins axi_bram_ctrl_2_bram/web]
  connect_bd_net -net Pmod_I2S2_0_ws [get_bd_ports ws_0] [get_bd_ports ws_1] [get_bd_pins Pmod_I2S2_0/ws]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins NeopixelDriver_0/doutb] [get_bd_pins axi_bram_ctrl_0_bram/doutb]
  connect_bd_net -net axi_bram_ctrl_1_bram_doutb [get_bd_pins Pmod_I2S2_0/douta] [get_bd_pins axi_bram_ctrl_1_bram/doutb]
  connect_bd_net -net axi_bram_ctrl_2_bram_doutb [get_bd_pins Pmod_I2S2_0/doutb] [get_bd_pins axi_bram_ctrl_2_bram/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins NeopixelDriver_0/s00_axi_aclk] [get_bd_pins Pmod_I2S2_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports mclk_0] [get_bd_ports mclk_1] [get_bd_pins Pmod_I2S2_0/mclk] [get_bd_pins axi_bram_ctrl_1_bram/clkb] [get_bd_pins axi_bram_ctrl_2_bram/clkb] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins NeopixelDriver_0/s00_axi_aresetn] [get_bd_pins Pmod_I2S2_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net sd_rx_0_1 [get_bd_ports sd_rx_0] [get_bd_pins Pmod_I2S2_0/sd_rx]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Pmod_I2S2_0/S00_AXI/S00_AXI_reg] -force
