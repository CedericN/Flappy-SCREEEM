...
proc create_root_design { parentCell } {
  ...
  set LEDG [ create_bd_port -dir O LEDG ]
  set LEDR [ create_bd_port -dir O LEDR ]

  # Create instance: NeopixelDriver_0, and set properties
  set NeopixelDriver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:NeopixelDriver:1.0 NeopixelDriver_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {7} \
...
1#UART 1#Unbonded#Unbonded#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins NeopixelDriver_0/S00_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  ...
  connect_bd_net -net LedMatrixCode_0_D_out [get_bd_ports D_out_0] [get_bd_ports LEDG] [get_bd_pins NeopixelDriver_0/D_out]
  connect_bd_net -net NeopixelDriver_0_addrb [get_bd_pins NeopixelDriver_0/addrb] [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net NeopixelDriver_0_dinb [get_bd_pins NeopixelDriver_0/dinb] [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net NeopixelDriver_0_enLed [get_bd_ports LEDR] [get_bd_pins NeopixelDriver_0/enLed]
  connect_bd_net -net NeopixelDriver_0_enb [get_bd_pins NeopixelDriver_0/enb] [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net NeopixelDriver_0_rstb [get_bd_pins NeopixelDriver_0/rstb] [get_bd_pins axi_bram_ctrl_0_bram/rstb]
  connect_bd_net -net NeopixelDriver_0_web [get_bd_pins NeopixelDriver_0/web] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins NeopixelDriver_0/doutb] [get_bd_pins axi_bram_ctrl_0_bram/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins NeopixelDriver_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins NeopixelDriver_0/InClock] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins NeopixelDriver_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs NeopixelDriver_0/S00_AXI/S00_AXI_reg] -force
