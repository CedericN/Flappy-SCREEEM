...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LedMatrixCode is
  ...
  attribute SOFT_HLUTNM of \bit[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \bit[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \bit[2]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \byte[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \byte[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \current_state[2]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of started_i_1 : label is "soft_lutpair2";
begin
  D_out <= \^d_out\;
...
\byte[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3C7D3C28"
    )
        port map (
...
\last_collor[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
