...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LedMatrixCode is
  ...
  signal \G_byte_reg_n_0_[0]\ : STD_LOGIC;
  ...
  signal \byte[2]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \last_collor[1]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \send_bit_reg[11]_i_3_n_0\ : STD_LOGIC;
  signal \send_bit_reg[11]_i_4_n_0\ : STD_LOGIC;
  signal started : STD_LOGIC;
  signal started_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bit[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \bit[4]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \byte[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \byte[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \last_collor[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \last_collor[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \last_collor[1]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of started_i_1 : label is "soft_lutpair1";
begin
  D_out <= \^d_out\;
...
\byte[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\byte[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\last_collor[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\last_collor[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFF7FFF80FF8000"
    )
        port map (
      I0 => \byte_reg_n_0_[0]\,
      I1 => \byte_reg_n_0_[1]\,
...
\last_collor[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\last_collor[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAA7FFF6AAA2AAA"
    )
        port map (
      I0 => current_state(1),
      I1 => \byte_reg_n_0_[0]\,
...
\last_collor[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFBA"
    )
        port map (
