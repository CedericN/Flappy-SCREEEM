...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LedMatrixCode is
  ...
  signal D_out_i_2_n_0 : STD_LOGIC;
  ...
  signal last_collor : STD_LOGIC_VECTOR ( 1 to 1 );
  signal \last_collor[0]_i_1_n_0\ : STD_LOGIC;
  signal \last_collor[0]_i_2_n_0\ : STD_LOGIC;
  signal \last_collor[0]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \byte[2]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \current_state[1]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \last_collor[0]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \last_collor[0]_i_3\ : label is "soft_lutpair0";
...
D_out_i_2: unisim.vcomponents.LUT6
    generic map(
...
\last_collor[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B7B4FFFFB7B40000"
    )
        port map (
      I0 => \last_collor[0]_i_2_n_0\,
      I1 => current_state(1),
      I2 => current_state(0),
      I3 => started,
      I4 => \last_collor[0]_i_3_n_0\,
      I5 => \last_collor_reg_n_0_[0]\,
      O => \last_collor[0]_i_1_n_0\
    );
\last_collor[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
      ...
      I1 => \byte_reg_n_0_[2]\,
      I2 => \byte_reg_n_0_[1]\,
      O => \last_collor[0]_i_2_n_0\
    );
\last_collor[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55555510"
    )
        port map (
